...
#import "ZhouTiXingViewController.h"
...
@interface ZhouTiXingViewController ()
...
@implementation ZhouTiXingViewController
...
- (void) getWithWebAPI
{
    ...
    NSString* urlStr = @"http://api.kimy.com.tw/Intra/api/PregnancyApp/ZhouTiXing";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //
    //    NSString *urlString = [NSString stringWithFormat:@"http://photo.kimy.com.tw/PhotoManagement/NewsletterImage/%@.png",baiKeEntity.photoName];
