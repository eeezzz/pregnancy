...
- (void)viewDidLoad
{
    ...
    {
        // iPhone 大小的調整
        self.contentTextView.frame = CGRectMake(05, 260, 300, textViewHeight);
        self.scrollView.contentSize = CGSizeMake(320,textViewHeight+260);
     }
    else
    {
        // iPad 大小的調整
        self.contentTextView.frame = CGRectMake(15, 540, 740, textViewHeight);
        self.scrollView.contentSize = CGSizeMake(self.scrollView.contentSize.width,textViewHeight+ 540);
    }
    ...
    // Room in , Room out 功能尚未開始試
//    self.contentTextView.maximumZoomScale = 2.0f;
